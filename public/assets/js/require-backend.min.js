...
define('../libs/require-css/css.min!../libs/viewer/viewer.min',[],function(){});
/*!
 * Viewer v1.0.0
...
define('table',['jquery', 'bootstrap', 'moment', 'viewer', 'moment/locale/zh-cn', 'bootstrap-table', 'bootstrap-table-lang', 'bootstrap-table-export', 'bootstrap-table-commonsearch', 'bootstrap-table-template'], function ($, undefined, Moment) {
    var Table = {
        list: {},
