define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'jrkj_category/index' + location.search,
                    add_url: 'jrkj_category/add',
                    edit_url: 'jrkj_category/edit',
                    del_url: 'jrkj_category/del',
                    multi_url: 'jrkj_category/multi',
                    table: 'jrkj_category',
                }
            });
