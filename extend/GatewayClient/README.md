...
GatewayWorker1.0请使用[1.0版本的GatewayClient](../../index.phpom/walkor/GatewayClient/releases/tag/v1.0)

GatewayWorker2.0.1-2.0.4请使用[2.0.4版本的GatewayClient](../../index.phpom/walkor/GatewayClient/releases/tag/2.0.4)

GatewayWorker2.0.5-2.0.6版本请使用[2.0.6版本的GatewayClient](../../index.phpom/walkor/GatewayClient/releases/tag/2.0.6)

GatewayWorker2.0.7版本请使用 [2.0.7版本的GatewayClient](../../index.phpom/walkor/GatewayClient/releases/tag/v2.0.7)

GatewayWorker3.0.0-3.0.7版本请使用 [3.0.0版本的GatewayClient](../../index.phpom/walkor/GatewayClient/releases/tag/v3.0.0)<br>

GatewayWorker3.0.8及以上版本请使用 [3.0.13版本的GatewayClient](../../index.phpom/walkor/GatewayClient/releases/tag/v3.0.13)<br>

注意：GatewayClient3.0.0以后支持composer并加了命名空间```GatewayClient``` <br>

[如何查看GatewayWorker版本请点击这里](../../index.phperman.net/get-gateway-version.html)
