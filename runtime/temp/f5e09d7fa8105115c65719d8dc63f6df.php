<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:90:"F:\WorkProgram\laragon\www\myone\public/../application/admin\view\litestoregoods\edit.html";i:1584069310;s:75:"F:\WorkProgram\laragon\www\myone\application\admin\view\layout\default.html";i:1562338655;s:72:"F:\WorkProgram\laragon\www\myone\application\admin\view\common\meta.html";i:1566781937;s:94:"F:\WorkProgram\laragon\www\myone\application\admin\view\litestoregoods\spec_many_template.html";i:1584069310;s:74:"F:\WorkProgram\laragon\www\myone\application\admin\view\common\script.html";i:1562338655;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-goods_name" data-rule="required" class="form-control form-control" name="row[goods_name]" type="text" value="<?php echo $row['goods_name']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Category_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-category_id" data-rule="required" data-source="litestorecategory/selectpage" class="form-control selectpage form-control" name="row[category_id]" type="text" value="<?php echo $row['category_id']; ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-images" data-rule="required" class="form-control form-control" size="50" name="row[images]" type="text" value="<?php echo $row['images']; ?>">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-spec_type" data-rule="required" class="form-control selectpicker" name="row[spec_type]">
                <?php if(is_array($specTypeList) || $specTypeList instanceof \think\Collection || $specTypeList instanceof \think\Paginator): if( count($specTypeList)==0 ) : echo "" ;else: foreach($specTypeList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['spec_type'])?$row['spec_type']:explode(',',$row['spec_type']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
    ...
    <div class="goods-spec-single" style="display: <?= $row['spec_type'] === '10' ? 'block' : 'none' ?>;"> 
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
                <input id="c-goods_no" class="form-control form-control" name="spec[goods_no]" type="text" value="<?php echo $row['spec']['0']['goods_no']; ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-xs-12 col-sm-2">商品价格:</label>
            <div class="col-xs-12 col-sm-8">
                <input id="c-goods_price" data-rule="required" class="form-control form-control" name="spec[goods_price]" type="number" value="<?php echo $row['spec']['0']['goods_price']; ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-xs-12 col-sm-2">商品划线价:</label>
            <div class="col-xs-12 col-sm-8">
                <input id="c-line_price" class="form-control form-control" name="spec[line_price]" type="number" value="<?php echo $row['spec']['0']['line_price']; ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-xs-12 col-sm-2">当前库存数量:</label>
            <div class="col-xs-12 col-sm-8">
                <input id="c-stock_num" class="form-control form-control" name="spec[stock_num]" type="number" value="<?php echo $row['spec']['0']['stock_num']; ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-xs-12 col-sm-2">商品重量(Kg):</label>
            <div class="col-xs-12 col-sm-8">
                <input id="c-goods_weight" class="form-control form-control" name="spec[goods_weight]" type="number" value="<?php echo $row['spec']['0']['goods_weight']; ?>">
            </div>
        </div>
    </div>
    <!-- 商品规格属性 end -->
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-deduct_stock_type" data-rule="required" class="form-control selectpicker" name="row[deduct_stock_type]">
                <?php if(is_array($deductStockTypeList) || $deductStockTypeList instanceof \think\Collection || $deductStockTypeList instanceof \think\Paginator): if( count($deductStockTypeList)==0 ) : echo "" ;else: foreach($deductStockTypeList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['deduct_stock_type'])?$row['deduct_stock_type']:explode(',',$row['deduct_stock_type']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-sales_initial" data-rule="required" class="form-control form-control" name="row[sales_initial]" type="number" value="<?php echo $row['sales_initial']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Sales_actual'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-sales_actual" data-rule="required" class="form-control form-control" name="row[sales_actual]" type="number" value="<?php echo $row['sales_actual']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Goods_sort'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-goods_sort" data-rule="required" class="form-control form-control" name="row[goods_sort]" type="number" value="<?php echo $row['goods_sort']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Delivery_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-delivery_id" data-rule="required" data-source="litestorefreight/index" class="form-control selectpage form-control" name="row[delivery_id]" type="text" value="<?php echo $row['delivery_id']; ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label for="row[goods_status]-<?php echo $key; ?>"><input id="row[goods_status]-<?php echo $key; ?>" name="row[goods_status]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['goods_status'])?$row['goods_status']:explode(',',$row['goods_status']))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label> 
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-is_delete" data-rule="required" class="form-control selectpicker" name="row[is_delete]">
                <?php if(is_array($isDeleteList) || $isDeleteList instanceof \think\Collection || $isDeleteList instanceof \think\Paginator): if( count($isDeleteList)==0 ) : echo "" ;else: foreach($isDeleteList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['is_delete'])?$row['is_delete']:explode(',',$row['is_delete']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
