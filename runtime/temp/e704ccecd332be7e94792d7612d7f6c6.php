<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"F:\WorkProgram\laragon\www\myone\addons\third\view\index\index.html";i:1566805712;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <script type="text/javascript">
            $(function () {
                var require =<?php echo json_encode($config); ?>
            });
        </script>
    </body>
</html>
