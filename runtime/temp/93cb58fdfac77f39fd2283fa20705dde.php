<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"F:\WorkProgram\laragon\www\myone\public/../application/index\view\user\login.html";i:1566874520;s:75:"F:\WorkProgram\laragon\www\myone\application\index\view\layout\default.html";i:1577497451;s:72:"F:\WorkProgram\laragon\www\myone\application\index\view\common\meta.html";i:1562338655;s:74:"F:\WorkProgram\laragon\www\myone\application\index\view\common\script.html";i:1562338655;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="user-section login-section">
        <div class="logon-tab clearfix"><a class="active"><?php echo __('Sign in'); ?></a> <a
                href="<?php echo url('user/register'); ?>?url=<?php echo urlencode($url); ?>"><?php echo __('Sign up'); ?></a></div>
        <div class="login-main">
            <form name="form" id="login-form" class="form-vertical" method="POST" action="">
                ...
                <div class="form-group">
                    <div class="controls">
                        ...
                        <div class="pull-right"><a href="javascript:;" class="btn-forgot"><?php echo __('Forgot password'); ?></a>
                        </div>
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="row">
                <div class="col-xs-4 col-sm-4">
                    <a href="<?php echo addon_url('third/index/connect',[':platform'=>'qq']); ?>"
                       class="btn bg-blue btn-default">
                        <i class="fa fa-qq"></i> QQ登录
                    </a>
                </div>
                <div class="col-xs-4 col-sm-4">
                    <a href="<?php echo addon_url('third/index/connect',[':platform'=>'wechat']); ?>"
                       class="btn bg-green">
                        <i class="fa fa-weixin"></i> 微信登录
                    </a>
                </div>
                <div class="col-xs-4 col-sm-4">
                    <a href="<?php echo addon_url('third/index/connect',[':platform'=>'weibo']); ?>"
                       class="btn bg-red btn-default">
            ...
            <div class="row" style="margin-top:10px;">
                <div class="col-xs-3 col-xs-offset-2">
                    <img data-type="alipay" width="80" class="btn btn-default btn-experience"
                         src="/assets/addons/epay/images/alipay.png" title="支付宝支付" alt="支付宝支付">
                </div> <div class="col-xs-3  col-xs-offset-1 ">
                    <img data-type="wechat" width="80" class="btn btn-default btn-experience"
                         src="/assets/addons/epay/images/wechat.png" title="微信支付" alt="微信支付">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-xs-12 col-sm-8">
                    <div class="radio">
                        <label for="type-email"><input id="type-email" checked="checked" name="type"
                                                       ...
                                                       data-check-url="<?php echo url('api/validate/check_ems_correct'); ?>"
                                                       type="radio" value="email"> <?php echo __('Reset password by
                            email'); ?></label>
                        <label for="type-mobile"><input id="type-mobile" name="type" type="radio"
                                                        data-send-url="<?php echo url('api/sms/send'); ?>"
                                                        data-check-url="<?php echo url('api/validate/check_sms_correct'); ?>"
                                                        value="mobile"> <?php echo __('Reset password by mobile'); ?></label>
                    </div>
                </div>
            </div>
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn" style="padding:0;border:none;">
                            <a href="javascript:;" class="btn btn-info btn-captcha" data-url="<?php echo url('api/ems/send'); ?>"
                               data-type="email" data-event="resetpwd"><?php echo __('Send verification code'); ?></a>
                        </span>
                    </div>
                    <span class="msg-box"></span>
                </div>
